...
class Packing_model extends CI_Model
{
    ...
    function json() {
        ...
        $this->datatables->add_column('action', anchor(site_url('packing/read/$1'),'Read')." | ".anchor(site_url('packing/update/$1'),'Update')." | ".anchor(site_url('packing/delete/$1'),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'), 'pk_id');
    ...
    function total_rows($q = NULL) {
        $this->db->like('pk_id', $q);
	$this->db->or_like('pk_name', $q);
